...
namespace CarFitProject.ViewModel
{
    public class CarListingFormViewModel : IValidatableObject
    {
        ...
        // ----- Seller inspection evidence (Phase 10; required for Used cars) -----
        public List<SellerInspectionUpload> ExistingInspectionUploads { get; set; } = new();

        [Display(Name = "Request CarFit Inspection")]
        public bool RequestInspection { get; set; }
