...
public partial class CarFitDbContext : DbContext
{
    ...
    public virtual DbSet<SellerInspectionUpload> SellerInspectionUploads { get; set; }
    ...
    // ── Phase 9.x: buyer lead signals ──
    public virtual DbSet<BuyerContactIntent> BuyerContactIntents { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Make>(entity =>
        {
            ...
            // Name mirrors Car.Make and is the lookup key, so it must be unique.
            entity.HasIndex(e => e.Name, "UX_Makes_Name").IsUnique();
        ...
        modelBuilder.Entity<SellerInspectionUpload>(entity =>
        {
            entity.HasKey(e => e.Id);

            entity.ToTable("SellerInspectionUploads");

            entity.HasIndex(e => e.CarId, "IX_SellerInspectionUploads_car_id");
            ...
            entity.HasOne(d => d.Car).WithMany(c => c.SellerInspectionUploads)
                .HasForeignKey(d => d.CarId)
        ...
        modelBuilder.Entity<Testimonial>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsApproved, "IX_Testimonials_is_approved");

            // One review per user: filtered unique index so a user_id can appear
            // at most once, while still allowing multiple NULLs (legacy rows /
            // any future anonymous path). Enforced in the DB on top of the
            // check-before-insert in TestimonialService.
            entity.HasIndex(e => e.UserId, "UX_Testimonials_user_id")
                .IsUnique()
                .HasFilter("[user_id] IS NOT NULL");

            // Id is left as the EF default (ValueGeneratedOnAdd) so SQL Server
            // creates it as an IDENTITY column — never assigned by application code.
            entity.Property(e => e.Id).HasColumnName("id");
        ...
        modelBuilder.Entity<SubscriptionPlan>(entity =>
        {
            ...
            entity.HasIndex(e => e.PlanCode, "UX_SubscriptionPlans_PlanCode").IsUnique();

            entity.Property(e => e.PlanCode).IsRequired().HasMaxLength(50);
            entity.Property(e => e.Name).IsRequired().HasMaxLength(100);
            entity.Property(e => e.AmountJod).HasColumnType("decimal(18, 3)");
            entity.Property(e => e.BillingInterval).HasConversion<string>().HasMaxLength(20);
            entity.Property(e => e.TargetRole).IsRequired().HasMaxLength(20);
        ...
        modelBuilder.Entity<Subscription>(entity =>
        {
            ...
            entity.HasIndex(e => e.StripeSubscriptionId, "UX_Subscriptions_StripeSubscriptionId")
                .IsUnique()
            ...
            entity.HasOne(e => e.Plan).WithMany(p => p.Subscriptions)
        ...
        modelBuilder.Entity<PaymentTransaction>(entity =>
        {
            ...
            // Idempotency guard: a Stripe charge id can be recorded at most once.
            entity.HasIndex(e => e.StripePaymentIntentId, "UX_PaymentTransactions_StripePaymentIntentId")
                .IsUnique()
            ...
            entity.HasOne(e => e.Subscription).WithMany(s => s.Transactions)
                .HasForeignKey(e => e.SubscriptionId)
                .OnDelete(DeleteBehavior.SetNull);

            entity.HasOne(e => e.CarListing).WithMany()
                .HasForeignKey(e => e.CarListingId)
                .OnDelete(DeleteBehavior.SetNull);
        });

        modelBuilder.Entity<BuyerContactIntent>(entity =>
        {
            entity.ToTable("BuyerContactIntents");
            entity.HasKey(e => e.Id);

            entity.HasIndex(e => e.ListingId, "IX_BuyerContactIntents_ListingId");
            entity.HasIndex(e => e.CreatedAt, "IX_BuyerContactIntents_CreatedAt");

            entity.Property(e => e.BuyerUserId).IsRequired().HasMaxLength(450);
            entity.Property(e => e.SellerUserId).HasMaxLength(450);
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getutcdate())");
        });
