...
public partial class Car
{
    ...
    /// <summary>Seller-provided raw inspection evidence (Phase 10). Required (≥1) for Used cars.</summary>
    public virtual ICollection<SellerInspectionUpload> SellerInspectionUploads { get; set; } = new List<SellerInspectionUpload>();
